...
public class TriceraConstants {
    ...
    public static final int REQUESTCODE_FROM_ERROR = 2;
    ...
    public static final int RESPONSE_TYPE_VBAR_COL2 = 12;
    public static final int RESPONSE_TYPE_VBAR_COL3 = 13;
    public static final int RESPONSE_TYPE_VBAR_COL4 = 14;
